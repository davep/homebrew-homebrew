class Evernote2md < Formula
  ...
  desc "A command line tool to make a Markdown vault from an Evernote notebook export"
  homepage "None"
  url "https://files.pythonhosted.org/packages/df/09/e6dc733b792f4d8b062dff2e9900fd279b4f8815cbbd8f3108ca022e0261/evernote2md-1.0.0.tar.gz"
